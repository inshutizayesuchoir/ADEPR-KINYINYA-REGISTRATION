...
st.markdown(
    ...
    <div class="intro-card">
        ...
        <div class="required-note" style="margin-top: 10px;">
...
st.markdown(
    """
    <div class="section-card" style="margin-bottom: 5px;">
...
st.markdown(
    """
    <div class="section-card" style="margin-top: 20px; margin-bottom: 5px;">
        <div class="section-header">
            <div class="section-icon">
                📍
            </div>
...
if submit:
    ...
    data = {
        ...
        "irangamuntu": irangamuntu.strip() if irangamuntu.strip() else None,
        "itariki_yamavuko": str(itariki_yamavuko),
        "igitsina": igitsina if igitsina != "" else None,
        "aho_yabatirijwe": aho_yabatirijwe.strip(),
        "yavukiye_intara": yavukiye_intara if yavukiye_intara else None,
        "yavukiye_akarere": yavukiye_akarere.strip(),
        "yavukiye_umurenge": yavukiye_umurenge.strip(),
        "yavukiye_akagari": yavukiye_akagari.strip(),
        "yavukiye_umudugudu": yavukiye_umudugudu.strip(),
        "atuye_intara": atuye_intara if atuye_intara else None,
        "atuye_akarere": atuye_akarere.strip(),
        "atuye_umurenge": atuye_umurenge.strip(),
        "atuye_akagari": atuye_akagari.strip(),
        "atuye_umudugudu": atuye_umudugudu.strip(),
        "igihande": igihande.strip(),
        "umurimo_itorero": umurimo_itorero,
        "chorale": chorale.strip(),
